-- ============================================================
-- RESET + FULL SETUP — Run ONCE in Supabase SQL Editor
-- Drops ALL existing objects, then recreates everything
-- ============================================================

-- === STEP 1: Drop RPC functions first ===
DROP FUNCTION IF EXISTS verify_student_login(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS verify_staff_login(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS verify_admin_login(TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS reset_student_password(TEXT, TEXT) CASCADE;
...
-- Reset sequence
SELECT setval('departments_department_id_seq', 10);
...
SELECT setval('courses_course_id_seq', 10);
...
SELECT setval('staff_staff_id_seq', 10);
...
SELECT setval('faculty_faculty_id_seq', 10);
...
SELECT setval('hod_hod_id_seq', 10);
...
SELECT setval('class_advisor_advisor_id_seq', 10);
...
SELECT setval('lab_assistant_assistant_id_seq', 10);
...
SELECT setval('warden_warden_id_seq', 10);
...
SELECT setval('library_staff_library_staff_id_seq', 10);
...
SELECT setval('librarian_librarian_id_seq', 10);
...
SELECT setval('library_books_book_id_seq', 58);
...
SELECT setval('library_issue_issue_id_seq', 10);
...
SELECT setval('library_fine_fine_id_seq', 10);
...
SELECT setval('hostel_hostel_id_seq', 10);
...
SELECT setval('hostel_rooms_room_id_seq', 10);
...
SELECT setval('hostel_students_allocation_id_seq', 10);
...
SELECT setval('bus_routes_route_id_seq', 10);
...
SELECT setval('bus_bus_id_seq', 10);
...
SELECT setval('bus_students_bus_student_id_seq', 10);
...
SELECT setval('subjects_subject_id_seq', 10);
...
SELECT setval('syllabus_syllabus_id_seq', 10);
...
SELECT setval('timetable_timetable_id_seq', 10);
...
SELECT setval('internal_marks_mark_id_seq', 10);
...
SELECT setval('semester_results_result_id_seq', 10);
...
SELECT setval('assignments_assignment_id_seq', 10);

-- 31. assignment_submission
...
SELECT setval('assignment_submission_submission_id_seq', 10);
...
SELECT setval('notes_note_id_seq', 10);

-- 33. previous_question_papers
...
SELECT setval('clubs_club_id_seq', 10);
...
SELECT setval('club_members_member_id_seq', 10);
...
SELECT setval('placements_placement_id_seq', 10);

-- 38. placement_registration
...
SELECT setval('placement_registration_registration_id_seq', 10);
...
SELECT setval('fees_fee_id_seq', 10);
...
SELECT setval('scholarships_scholarship_id_seq', 10);
...
SELECT setval('complaints_complaint_id_seq', 10);
...
SELECT setval('lost_and_found_item_id_seq', 10);
...
SELECT setval('announcements_announcement_id_seq', 10);
...
SELECT setval('notifications_notification_id_seq', 10);
...
SELECT setval('ai_chat_history_chat_id_seq', 10);
...
SELECT setval('buildings_building_id_seq', 10);

-- 47. campus_navigation
...
SELECT setval('campus_navigation_location_id_seq', 10);
...
SELECT setval('labs_lab_id_seq', 10);
...
SELECT setval('lab_equipment_equipment_id_seq', 10);
...
SELECT setval('classrooms_classroom_id_seq', 10);
...
SELECT setval('canteen_menu_item_id_seq', 10);
...
SELECT setval('alumni_alumni_id_seq', 10);
...
SELECT setval('visitors_visitor_id_seq', 10);

-- 54. emergency_contacts
...
SELECT setval('emergency_contacts_contact_id_seq', 10);
...
SELECT setval('feedback_feedback_id_seq', 10);

-- ============================================================
-- RPC FUNCTIONS FOR LOGIN
-- ============================================================
